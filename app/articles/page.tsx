...
export const metadata = {
  title: `Honest Answers for Wisconsin Homeowners | ${config.companyName}`,
  description:
    "Plain-English articles for homeowners thinking about selling in Wisconsin. What a cash offer really means, how the math works, how to vet a buyer, and whether now is the right time.",
}
          ...
          {ARTICLES.map((a) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <span className="text-[15px] font-semibold text-[#1a4d8f]">Read the article &rarr;</span>
              </div>
            </Link>
          ))}
        </div>
